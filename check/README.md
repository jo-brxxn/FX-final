...
| `rezept.js` | **Zweite App (Perfect Rezept):** jeder Inline-Handler loest sich zu einer echten Funktion auf, jeder sichtbare Button veraendert wirklich den DOM, der komplette Ablauf (anlegen mit echtem Bild-Upload, bearbeiten, favorisieren, filtern, Papierkorb, Themes, Theme-Migration), die Nachfrage bei ungespeicherten Eingaben, Kontrast jeder Palette gegen jede Flaeche | ja |
